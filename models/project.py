...
class Project:
    ...
    def __str__(self):
        return f"Project: {self.title} | {self.description} | Due: {self.due_date}"
...
class ProjectManager:
    ...
    def load_projects(self):
        ...
        return [Project(p["title"], p["description"], p["due_date"]) for p in data]

    def save_projects(self):
        data = [{"title": p.title, "description": p.description, "due_date": p.due_date}
